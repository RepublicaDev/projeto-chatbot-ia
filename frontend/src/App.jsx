...
function App() {
  ...
  const [messages, setMessages] = useState([{ text: "Olá! Sou sua IA. Como posso ajudar?", isBot: true }]);
  ...
  try {
    ...
    setMessages(prev => [...prev, { text: "Ops, tive um erro técnico aqui.", isBot: true }]);
  }
  };
      ...
      <div className="auth-container">
        <div className="auth-card">
          ...
          <div className="auth-buttons">
            ...
            <button className="secondary" onClick={() => handleAuth('signup')}>Cadastrar</button>
          </div>
        </div>
      </div>
    );
